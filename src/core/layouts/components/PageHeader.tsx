...
import avatar5 from '@/core/templates/img/avatars/avatar-5.jpg';
import avatar4 from '@/core/templates/img/avatars/avatar-4.jpg';
import avatar3 from '@/core/templates/img/avatars/avatar-3.jpg';
import avatar2 from '@/core/templates/img/avatars/avatar-2.jpg';
import avatar1 from '@/core/templates/img/avatars/avatar.jpg';
				...
				<ul className="navbar-nav navbar-align">
					...
					<li className="nav-item dropdown">
						...
						<a
							...
							data-bs-toggle="dropdown"
						>
							<img src={avatar1} className="avatar img-fluid rounded me-1" alt="Charles Hall" />{' '}
						...
						<div className="dropdown-menu dropdown-menu-end">
							...
							<div className="dropdown-divider"></div>
							<a className="dropdown-item" href="#" onClick={closeSession}>
								Log out
							</a>
						</div>
					</li>
